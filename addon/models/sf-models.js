...
SFModels = SF = {
	...
	hasCustomSfRelationExtension : function(name) { return SF.endsWith(name, SF._sfRelExt); },
	hasCustomSfNameExtension : function(name) { return SF.endsWith(name, SF._sfNameExt); },
	hasCustomEmberRelationExtension : function(name) { return SF.endsWith(name, SF._emRelExt); },
	hasCustomEmberNameExtension : function(name) { return SF.endsWith(name, SF._emNameExt); },
